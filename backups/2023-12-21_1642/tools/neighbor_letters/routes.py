from flask import Blueprint, render_template, request, jsonify, session, current_app, flash
import pandas as pd
import logging
import traceback
...
def init_apis():
    """Initialize API clients after app is created"""
    global auction_api, letter_generator
